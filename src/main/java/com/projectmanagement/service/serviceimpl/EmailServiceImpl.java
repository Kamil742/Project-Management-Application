...
public class EmailServiceImpl {
    ...
    public String sendOtpEmail(User user) {
        ...
        try {
            ...
            helper.setSubject("Your One-Time Password (OTP) for Future Technologies");
    ...
    public String sendForgotPasswordOtp(User user) {
        ...
        try {
            ...
            helper.setFrom("kamilpraseej742@gmail.com");
            helper.setTo(user.getUsername());
            helper.setSubject("Future Technologies - Forgot Password OTP Verification");
            helper.setText(emailContent, true);
    ...
    public String  sendEmail(User user) {
        ...
        try {
            ...
            helper.setFrom("kamilpraseej742@gmail.com");
            helper.setTo(user.getUsername());
            helper.setSubject("Welcome to Future Technologies - Your Login Credentials");
            helper.setText(emailContent, true);
